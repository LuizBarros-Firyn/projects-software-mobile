...
export default function ClientRegister() {
    ...
    async function handleLogin() {
        if (!firstName || !lastName || !password || !age || !companyName || !city || !uf || !email) {
        ...
        if (companyName.length <= 2 || companyName.length >= 80) {
            Alert.alert('Negócio inválido', 'O negócio informado está inválido');
            return
        }
    ...
    return(
        ...
        >
            <View style={styles.container}>
                ...
                <TextInput value={companyName} onChangeText={e => setCompanyName(e)} placeholderTextColor={'grey'} style={styles.field}  placeholder="Nome do seu negócio" />
